...
struct ModelSelectionView: View {
    ...
    @State private var enableExternalAIProviders: Bool = Defaults[.enableExternalAIProviders]
                    ...
                    HStack {
                        VStack(alignment: .leading, spacing: 4) {
                            Text("Allow Cloud AI Providers")
                                .font(.body)
                                .foregroundColor(.primary)
                            Text("External providers can receive prompts and attached file contents.")
                                .font(.caption)
                                .foregroundColor(.secondary)
                        }
                        Spacer()
                        Toggle("", isOn: $enableExternalAIProviders)
    ...
    private var isConfigurationValid: Bool {
        ...
        case .gemini:
            return !enableExternalAIProviders || !geminiApiKey.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
        case .openai:
            return !enableExternalAIProviders || !openaiApiKey.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
        case .claude:
            return !enableExternalAIProviders || !claudeApiKey.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
        case .local:
            return !localEndpoint.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
        case .groq:
            return !enableExternalAIProviders || !groqApiKey.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
        }
    }
    ...
    private func loadCurrentConfiguration() {
        ...
        enableExternalAIProviders = Defaults[.enableExternalAIProviders]
    ...
    private func saveConfiguration() {
        ...
        Defaults[.enableExternalAIProviders] = enableExternalAIProviders
