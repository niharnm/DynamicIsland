...
struct ChatInputView: View {
    ...
    var body: some View {
        ...
        .alert("API Key Required", isPresented: $showingApiKeyAlert) {
            ...
            Text("Enable cloud AI providers and configure the selected provider's API key in model settings, or switch to a local model.")
        }
        .onAppear {
    ...
    private func sendMessage() {
        ...
        if provider != .local && !Defaults[.enableExternalAIProviders] {
