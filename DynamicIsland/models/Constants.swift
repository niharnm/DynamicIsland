...
extension Defaults.Keys {
    ...
    static let privacySafeDefaultsVersion = Key<Int>("privacySafeDefaultsVersion", default: 0)
    ...
    static let showSneakPeekOnTrackChange = Key<Bool>("showSneakPeekOnTrackChange", default: false)
    ...
    static let lockScreenWeatherShowsLocation = Key<Bool>("lockScreenWeatherShowsLocation", default: false)
    ...
    static let enableExternalAIProviders = Key<Bool>("enableExternalAIProviders", default: false)
    ...
    static let enableExtensionRemoteRequests = Key<Bool>("enableExtensionRemoteRequests", default: false)
    ...
    static let enableMusicMetadataLookups = Key<Bool>("enableMusicMetadataLookups", default: false)
    static let enableRemoteArtworkLoading = Key<Bool>("enableRemoteArtworkLoading", default: false)
    static let enableRemoteIdleAnimationURLs = Key<Bool>("enableRemoteIdleAnimationURLs", default: false)
    ...
    static let enableCreateFromClipboard = Key<Bool>("enableCreateFromClipboard", default: false)
    ...
    static func applyPrivacySafeDefaultsIfNeeded() {
        guard Defaults[.privacySafeDefaultsVersion] < 1 else { return }
        ...
        Defaults[.lockScreenWeatherShowsLocation] = false
        Defaults[.lockScreenWeatherShowsAQI] = false
        ...
        Defaults[.openShelfByDefault] = false
        Defaults[.quickShareProvider] = "AirDrop"
        ...
        Defaults[.enableExternalAIProviders] = false
        Defaults[.enableThinkingMode] = false
        ...
        Defaults[.enableExtensionRemoteRequests] = false
        ...
        Defaults[.enableMusicMetadataLookups] = false
        Defaults[.enableRemoteArtworkLoading] = false
        Defaults[.enableRemoteIdleAnimationURLs] = false
        Defaults[.enableCreateFromClipboard] = false
        ...
        Defaults[.showNetworkGraph] = false
        Defaults[.showDiskGraph] = false

        UserDefaults.standard.removeObject(forKey: "ClipboardHistory")
        UserDefaults.standard.removeObject(forKey: "ClipboardPinnedItems")
        UserDefaults.standard.removeObject(forKey: "ScreenAssistantFiles")

        let fileManager = FileManager.default
        let documentsPath = fileManager.urls(for: .documentDirectory, in: .userDomainMask).first
        if let documentsPath {
            try? fileManager.removeItem(at: documentsPath.appendingPathComponent("ClipboardData"))
            try? fileManager.removeItem(at: documentsPath.appendingPathComponent("ScreenAssistantAudio"))
            try? fileManager.removeItem(at: documentsPath.appendingPathComponent("ScreenAssistantScreenshots"))
        }
        let cachePath = fileManager.urls(for: .cachesDirectory, in: .userDomainMask).first
        if let cachePath {
            try? fileManager.removeItem(at: cachePath.appendingPathComponent("artwork_cache"))
        }

        Defaults[.privacySafeDefaultsVersion] = 1
    }
